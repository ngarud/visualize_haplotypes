...
Rscript ${script_dir}/hapData_viz_annotate_strain.R ~/H12_visualization/tmp_intermediate/${coord}_H12_H2H1_tmp.txt ~/H12_visualization/tmp_intermediate/${coord}_data_tmp.txt $outFile $window $sampleSize $chr $win_H12
