...
Rscript ${script_dir}/hapData_viz_annotate_strain.R ${coord}_H12_H2H1_tmp.txt ${coord}_data_tmp.txt $outFile $window $sampleSize

rm ${coord}_data_tmp.txt 
rm ${coord}_H12_H2H1_tmp.txt
